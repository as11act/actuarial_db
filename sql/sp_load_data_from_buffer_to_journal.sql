-- PROCEDURE: public.sp_load_data_from_buffer_to_journal(character varying, boolean)

-- DROP PROCEDURE public.sp_load_data_from_buffer_to_journal(character varying, boolean);
