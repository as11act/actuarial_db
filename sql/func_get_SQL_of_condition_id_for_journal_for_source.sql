-- FUNCTION: public.func_get_SQL_of_condition_id_for_journal_for_source(bigint, bigint, bigint)

-- DROP FUNCTION public."func_get_SQL_of_condition_id_for_journal_for_source"(bigint, bigint, bigint);

CREATE OR REPLACE FUNCTION public."func_get_SQL_of_condition_id_for_journal_for_source"(
	id_condition bigint,
	id_jur bigint,
	id_src0 bigint)
...
ALTER FUNCTION public."func_get_SQL_of_condition_id_for_journal_for_source"(bigint, bigint, bigint)
    OWNER TO postgres;
